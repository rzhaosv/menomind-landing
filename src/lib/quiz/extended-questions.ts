...
export const CORE_QUESTIONS: QuizQuestion[] = [
  // Q1: Symptom concern — validates the ad click, creates micro-commitment
  {
    ...
    subtitle: 'Tap the one that sounds most like you.',
    options: [
      'Waking up at 3am \u2014 for no reason',
      'New anxiety \u2014 that appeared out of nowhere',
      'Brain fog \u2014 forgetting words, losing focus',
      'Rage or irritability \u2014 that isn\'t "just stress"',
      'Heart palpitations \u2014 random, out of nowhere',
      'Feeling unlike yourself \u2014 but you can\'t explain why',
    ],
    icons: ['dark_mode', 'stress', 'cognition', 'mood_bad', 'cardiology', 'person_off'],
    type: 'single',
  },
