...
export const CORE_QUESTIONS: QuizQuestion[] = [
  // Q1: Symptom concern — validates the ad click, creates micro-commitment
  {
    ...
    options: [
      '3am anxiety that comes out of nowhere',
      'Brain fog \u2014 forgetting words mid-sentence',
      'Rage or irritability that doesn\'t feel like "just stress"',
      'Sleep problems \u2014 can\'t fall or stay asleep',
      'Random heart palpitations or racing heart',
      'Feeling unlike myself \u2014 but I can\'t explain it',
    ],
    icons: ['anxiety', 'psychology', 'mood_bad', 'bedtime', 'heart_broken', 'person_off'],
    type: 'single',
  },
