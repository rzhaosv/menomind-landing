/**
 * MenoMind AI Client â Multi-model support
 * 
 * Supports routing to:
...
// ââ Anthropic client ââââââââââââââââââââââââââââââââââââââââââââââââ
...
// ââ OpenAI client (lazy, only loaded if nano tier is used) ââââââââââ
...
// ââ Streaming chat (Anthropic models only) ââââââââââââââââââââââââââ
...
// ââ Non-streaming generation (plans, reports) âââââââââââââââââââââââ
...
// ââ Provider-specific generators ââââââââââââââââââââââââââââââââââââ
